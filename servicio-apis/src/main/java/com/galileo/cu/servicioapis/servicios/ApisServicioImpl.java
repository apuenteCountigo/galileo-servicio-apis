...
public class ApisServicioImpl implements ApisServicio {
    ...
    @Override
    public ConnectAppResultDataMiner salvarElementoDataMinerBalizaServ(URI uri, DataMinerBaliza dataMinerBaliza) {
        return dataMinerFeignClient.salvarElementoDataMinerBaliza(uri, dataMinerBaliza);
    }
