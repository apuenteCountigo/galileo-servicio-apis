...
public interface ApisServicio {
        ...
        ResponseEntity<UsuarioTraccar> salvarUsuarioTraccarServ(URI uri, UsuarioTraccar usuarioTraccar,
                        String authHeader);
        ...
        ResponseEntity<?> usuarioAgregarPermisoDevicesTraccarServ(URI uri,
                        PermisosDevicesTraccar permisosDevicesTraccar,
                        String authHeader);

        ResponseEntity<?> usuarioEliminarPermisoDevicesTraccarServ(URI uri,
                        PermisosDevicesTraccar permisosDevicesTraccar,
                        String authHeader);
        ...
        ResponseEntity<?> getGeocerca(URI uri, String conexionToken, Integer dmaId, Integer elementId,
                        Integer parameterId);

        ResultadoCantidadLicencia obtenerCantidadLicenciaDataMinerServ(URI uri, ConexionId idConect);

        boolean isQtyElementFull(URI uri, ConexionId idConect);
